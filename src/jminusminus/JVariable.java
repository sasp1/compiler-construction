...
class JVariable extends JExpression implements JLhs {
	...
	/**
	 * The semantics of j-- require that we implement short-circuiting branching in
	 * implementing the identifier expression.
	 * 
	 * @param output      the code emitter (basically an abstraction for producing
	 *                    the .class file).
	 ...
	 * assignment. Here, this requires nothing; all information is in the the store
	 * instruction.
	 * 
	...
	/**
	 * Generate the code required for loading an Rvalue for this variable, eg for
	 * use in a +=. Here, this requires loading the Rvalue for the variable
	 * 
	 * @param output the emitter (an abstraction of the class file).
	 */
	...
	/**
	 * Generate the code required for duplicating the Rvalue that is on the stack
	 * becuase it is to be used in a surrounding expression, as in a[i] = x = <expr>
	 * or x = y--. Here this means simply duplicating the value on the stack.
	 * 
	 * @param output the code emitter (basically an abstraction for producing the
	 *               .class file).
	 */
